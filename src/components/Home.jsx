    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-screen">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          ...
          >
            <h1 className="text-5xl font-bold mb-4">Welcome to Connect Hub</h1>
        ...
        <div className="max-w-7xl mx-auto ">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className={`${textColorClass}`}>
                Find your perfect code partner with our intuitive swipe
                interface
              </p>
            </motion.div>
      ...
      <section className="py-20">
        <div className="diff aspect-[16/9]">
          <div className="diff-item-1">
            <div
              className="bg-gradient-to-r from-rose-500 to-pink-500 text-primary-content grid place-content-center text-9xl font-black"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className={`${textColorClass}`}>
                Our AI matches you with developers based on coding style and
                expertise
              </p>
            </motion.div>
